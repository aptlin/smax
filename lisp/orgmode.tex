% Created 2016-11-07 Mon 21:39
%%% Local Variables:
%%% mode: latex
%%% TeX-master: t
%%% End:
\documentclass[11pt]{scrartcl}
\usepackage[beaue, href]{scrartcl}
\author{aleph}
\date{\today}
\title{Org Mode - Organize Your Life In Plain Text!}
\hypersetup{
 pdfauthor={aleph},
 pdftitle={Org Mode - Organize Your Life In Plain Text!},
 pdfkeywords={org-mode Emacs organization GTD getting-things-done git},
...
I have added key bindings for the agenda to allow using \texttt{C-c C-x <} in
...
want to limit the view to part of the subtree.  This is why I keep the \texttt{N} and
\texttt{U} key bindings for adjusting the narrowed region.
